...
$(window).load(function(){
	...
	var video = '<iframe frameborder="0" width="640" height="498" id="video" src="http://v.qq.com/iframe/player.html?vid=k0159imq3ki&tiny=0&auto=0" allowfullscreen></iframe>';
...
function p1Animate(){
	...
	$(".i-title-text1").removeClass("hide").addClass('show zoomInLeft animated1 delay2_1');
	$(".i-title-text2").addClass('fadeInUp animated delay3_1');
	$("#p1 .i-to-go").addClass('fadeIn animated delay4');
}
function p1removeAnimate(){
	...
	$(".i-title-text1").removeClass('zoomInLeft animated1 delay3');
	$(".i-title-text2").removeClass('fadeInUp animated delay4');
	$("#p1 .i-to-go").removeClass('fadeIn animated delay5');
	if($("#video").length==0){
		var video = '<iframe frameborder="0" width="640" height="498" src="http://v.qq.com/iframe/player.html?vid=k0159imq3ki&tiny=0&auto=0" allowfullscreen id="video"></iframe>  ';
		$("#videotion").append(video);
	}
	p1complete = false;
}
function p2Animate(){
	...
	$(".i-p5-text1").addClass('fadeIn animated0_5 delay1_1');
	$(".i-p5-text2").addClass('fadeIn animated0_5 delay2_3');
	$(".i-p5-pc").addClass('fadeIn animated0_5 delay3');
	$(".i-p5-brush").addClass('fadeIn animated0_5 delay3_8');
	$(".i-p5-text3").addClass('fadeIn animated0_5 delay4_1');
	$(".i-p5-text4").addClass('fadeIn animated0_8 delay5');
	$(".i-p5-text5").addClass('fadeIn animated0_8 delay5_1');
	setTimeout(function(){
		$(".i-crown").removeClass("hide").addClass("show");
	}, 6000)
	$(".i-crown").addClass('wobble animated delay6');
	$("#p2 .i-to-go-white").addClass('fadeIn animated delay6_1');
}
function p2RemoveAnimate(){
	$(".i-p5-title").removeClass('bounceInDown animated0_8 delay0_1');
	$(".i-p5-text1").removeClass('fadeIn animated0_5 delay1_1');
	$(".i-p5-text2").removeClass('fadeIn animated0_5 delay2_3');
	$(".i-p5-pc").removeClass('fadeIn animated0_5 delay3');
	$(".i-p5-brush").removeClass('fadeIn animated0_5 delay3_8');
	$(".i-p5-text3").removeClass('fadeIn animated0_5 delay4_1');
	$(".i-p5-text4").removeClass('fadeIn animated0_8 delay5');
...
function checkTask(pageNum, checkIndexs){
	setTimeout(function(){
		var i=0;
		var jQpage = $("#p"+pageNum);
		var length = checkIndexs.length;
		function check(){   
		   if(i<length) setTimeout(function(){
		     jQpage.find(".i-check:eq("+checkIndexs[i-1]+")").removeClass("i-check-black").addClass("i-check-white");
		     check();
		   },250);
		   i++;		   	
		}
...
function removeCheckTask(pageNum){
	var jQpage = $("#p"+pageNum);
	jQpage.find(".i-check").removeClass("i-check-white").addClass("i-check-black");
...
function p6Animate(){
	...
	$(".d-p6-week1").addClass('fadeIn animated delay3_3');
	$(".d-p6-data1").addClass('fadeIn animated delay4');
	$("#p6 .stars").addClass('fadeIn animated delay4_1');
	animateStar(6, 3);
	$(".d-p6-result1").addClass('fadeIn animated delay6');
	$(".d-p6-data2").addClass('fadeIn animated delay6_1');
	$("#p6 .checks").addClass('fadeIn animated delay7');
	checkTask(6, [0,1,3]);
	$("#p6 .i-to-go-white").addClass('fadeIn animated delay8_1');
}
function p6RemoveAnimate(){
	...
	$(".d-p6-week1").removeClass('fadeIn animated delay3_3');
	$(".d-p6-data1").removeClass('fadeIn animated delay4');
	$("#p6 .stars").removeClass('fadeIn animated delay4_1');
	removeAnimateStar(6);
	$(".d-p6-result1").removeClass('fadeIn animated delay6');
	removeCheckTask(6);
	$(".d-p6-data2").removeClass('fadeIn animated delay6_1');
	$("#p6 .checks").removeClass('fadeIn animated delay7');
	$("#p6 .i-to-go-white").removeClass('fadeIn animated delay8_1');
	p6complete = false;
}
function p7Animate(){
	...
	$(".d-p7-week1").addClass('fadeIn animated delay3_3');
	$(".d-p7-data1").addClass('fadeIn animated delay4');
	$("#p7 .stars").addClass('fadeIn animated delay4_1');
	animateStar(7, 3);
	$(".d-p7-result1").addClass('fadeIn animated delay6');
	$(".d-p7-data2").addClass('fadeIn animated delay6_1');
	$("#p7 .checks").addClass('fadeIn animated delay7');
	checkTask(7, [0,1,3]);
	$("#p7 .i-to-go-white").addClass('fadeIn animated delay8_1');
}
function p7RemoveAnimate(){
	...
	$(".d-p7-week1").removeClass('fadeIn animated delay3_3');
	$(".d-p7-data1").removeClass('fadeIn animated delay4');
	$("#p7 .stars").removeClass('fadeIn animated delay4_1');
	removeAnimateStar(7);
	$(".d-p7-result1").removeClass('fadeIn animated delay6');
	removeCheckTask(7);
	$(".d-p7-data2").removeClass('fadeIn animated delay6_1');
	$("#p7 .checks").removeClass('fadeIn animated delay7');
	$("#p7 .i-to-go-white").removeClass('fadeIn animated delay8_1');
	p7complete = false;
}
function p8Animate(){
	...
	$(".d-p8-week1").addClass('fadeIn animated delay3_3');
	$(".d-p8-data1").addClass('fadeIn animated delay4');
	$("#p8 .stars").addClass('fadeIn animated delay4_1');
	animateStar(8, 5);
	$(".d-p8-result1").addClass('fadeIn animated delay6');
	$(".d-p8-data2").addClass('fadeIn animated delay6_1');
	$("#p8 .checks").addClass('fadeIn animated delay7');
	checkTask(8, [0,1,2,3]);
	$("#p8 .i-to-go-white").addClass('fadeIn animated delay8_1');
}
function p8RemoveAnimate(){
	...
	$(".d-p8-week1").removeClass('fadeIn animated delay3_3');
	$(".d-p8-data1").removeClass('fadeIn animated delay4');
	$("#p8 .stars").removeClass('fadeIn animated delay4_1');
	removeAnimateStar(8);
	$(".d-p8-result1").removeClass('fadeIn animated delay6');
	removeCheckTask(8);
	$(".d-p8-data2").removeClass('fadeIn animated delay6_1');
	$("#p8 .checks").removeClass('fadeIn animated delay7');
	$("#p8 .i-to-go-white").removeClass('fadeIn animated delay8_1');
	p8complete = false;
}
function p9Animate(){
	...
	$(".d-p9-week1").addClass('fadeIn animated delay3_3');
	$(".d-p9-data1").addClass('fadeIn animated delay4');
	$("#p9 .stars").addClass('fadeIn animated delay4_1');
	animateStar(9, 4);
	$(".d-p9-result1").addClass('fadeIn animated delay6');
	checkTask(9, [0,2,3]);
	$(".d-p9-data2").addClass('fadeIn animated delay6_1');
	$("#p9 .checks").addClass('fadeIn animated delay7');
	$("#p9 .i-to-go-white").addClass('fadeIn animated delay8_1');
	p9complete = false;
}
function p9RemoveAnimate(){
	...
	$(".d-p9-week1").removeClass('fadeIn animated delay3_3');
	$(".d-p9-data1").removeClass('fadeIn animated delay4');
	$("#p9 .stars").removeClass('fadeIn animated delay4_1');
	removeAnimateStar(9);
	$(".d-p9-result1").removeClass('fadeIn animated delay6');
	removeCheckTask(9);
	$(".d-p9-data2").removeClass('fadeIn animated delay6_1');
	$("#p9 .checks").removeClass('fadeIn animated delay7');
	$("#p9 .i-to-go-white").removeClass('fadeIn animated delay8_1');
}
function p10Animate(){
