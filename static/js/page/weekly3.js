...
$(window).load(function(){
	...
	var video = '<iframe frameborder="0" width="640" height="498" id="video" src="http://v.qq.com/iframe/player.html?vid=k01600x3pac&tiny=0&auto=0" allowfullscreen></iframe>';
...
function p1removeAnimate(){
	...
	if($("#video").length==0){
		var video = '<iframe frameborder="0" width="640" height="498" src="http://v.qq.com/iframe/player.html?vid=k01600x3pac&tiny=0&auto=0" allowfullscreen id="video"></iframe>  ';
		$("#videotion").append(video);
	}
	p1complete = false;
}
